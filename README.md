...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fog2bdq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fog2bdq.containers.anotherwebservice.com/
...
```
git clone git@github.com:ItsGloKeR/pc.git
cd container-fog2bdq
```
...
```
docker attach container-fog2bdq
```
